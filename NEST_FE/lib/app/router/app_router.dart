...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/erp/students/new', builder: (context, state) => const UserListScreen()),
      GoRoute(path: '/erp/courses', builder: (context, state) => const CourseListScreen()),
      ...
      GoRoute(path: '/erp/study-materials', builder: (context, state) => const StudyMaterialHomeScreen()),
      ...
      GoRoute(path: '/erp/scheduling', builder: (context, state) => const ScheduleScreen()),
      GoRoute(path: '/erp/attendance', builder: (context, state) => const AttendanceHomeScreen()),
